...
def calculate_session(opens: list[Decimal], highs: list[Decimal], lows: list[Decimal], closes: list[Decimal], output: list[dict[str, FeatureValue]]) -> None:
    for index in range(len(closes)):
        output[index].update(session_values(opens, highs, lows, closes, index))
