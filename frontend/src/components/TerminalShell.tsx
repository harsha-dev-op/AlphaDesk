...
import { Activity, BarChart3, Bot, ChartCandlestick, Database, FileSearch, FlaskConical, LayoutDashboard, LockKeyhole, Newspaper, Search, Settings, ShieldCheck } from 'lucide-react';
...
const groups = [
  ...
  { label: 'Research', items: [{ href: '/strategies', label: 'Strategies', icon: FlaskConical }, { href: '', label: 'Backtests', icon: FileSearch, future: true }] },
