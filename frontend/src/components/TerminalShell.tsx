...
const groups = [
  ...
  { label: 'Research', items: [{ href: '/strategies', label: 'Strategies', icon: FlaskConical }, { href: '/backtests', label: 'Backtests', icon: FileSearch }] },
